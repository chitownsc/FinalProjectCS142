			...
			<div id="mainWrapper" class="main">
				<div class="wrapRow">
					<div class="wrap">
						...
						<img id="thesisImg" class="coverImg" onload="autoPlayAll()" src="images/thesis/small/photo0.png">
					</div>
					<div class="wrap">
						<img id="courseWorkCover" onclick="window.location = 'courseWork.php';" class="cover" src="images/cover/photo1.png">
						<img id="courseWorkImg" class="coverImg" src="images/courseWork/small/photo0.png">
					</div>
				</div>
				<div class="wrapRow">
					<div class="wrap">
						<img id="travelCover" onclick="window.location = 'travel.php';" class="cover" src="images/cover/photo2.png">
						<img id="travelImg" class="coverImg" src="images/travel/small/photo0.png">
					</div>
					<div class="wrap">
						<img id="commisionCover" onclick="window.location = 'commision.php';" class="cover" src="images/cover/photo3.png">
						<img id="commisionImg" class="coverImg" src="images/commision/small/photo0.png">
					</div>
				</div>
			</div>
		</div>
